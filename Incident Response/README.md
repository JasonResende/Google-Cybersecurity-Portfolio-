...
Welcome to my cybersecurity portfolio. This repository contains hands-on projects and lab reports completed during my professional certification. Each folder demonstrates a core competency required for a Security Operations Center (SOC) or Junior Security Analyst role.

---

## 🛠️ Technical Skill Sets
* **Programming & Automation:** Python (Scripting for Security), Bash.
* **Data & Analysis:** SQL (Threat Hunting), Log Analysis (SIEM).
* **Operating Systems:** Linux (Hardening & Permissions), Windows Security.
* **Frameworks:** NIST Cybersecurity Framework (CSF), NIST SP 800-53.
* **Tools:** Chronicle, Splunk, Suricata, Wireshark, Tcpdump.

---

## 📂 Project Directories

### 🐍 [Python: Security Automation](./Google-Cybersecurity-Portfolio/Python-Project/)
...
### 🐧 [Linux: System Hardening](./Linux-Security/)
